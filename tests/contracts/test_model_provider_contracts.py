...
from tests.test_doubles import FakeProvider, ChatResponse, UsageStats
from tests.fixtures import api_response_factory
...
class TestProviderErrorHandling:
    ...
    @pytest.mark.parametrize("provider_class,model_id", [
...
class TestProviderCostCalculation:
    ...
    @pytest.mark.parametrize("provider_factory,model_id,expected_cost_range", [
    ...
    def test_cost_calculation_reasonable(self, provider_factory, model_id, expected_cost_range):
        ...
        assert min_cost <= cost <= max_cost, f"Cost {cost} not in expected range {expected_cost_range}"