...
def main():
    ...
    if args.category == "all":
        ...
        test_paths = ["tests/unit/models/", "tests/integration/api/test_models_api.py"]
        ...
        test_paths = ["tests/unit/xcs/", "tests/integration/xcs/"]
        ...
        test_paths = ["tests/"]
        cmd.extend(["-m", "not benchmark", "--maxfail=10", "--tb=short"])
