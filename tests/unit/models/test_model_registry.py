...
class TestModelRegistry:
    ...
    @pytest.mark.parametrize(
        "env_config,expected_key",
        [
            pytest.param({"OPENAI_API_KEY": "standard-key"}, "standard-key", id="standard-env-var"),
            pytest.param(
                {"EMBER_OPENAI_API_KEY": "ember-key"}, "ember-key", id="ember-prefixed-var"
            ),
            pytest.param(
