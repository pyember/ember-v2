...
from ember.cli.main import main, cmd_configure, cmd_setup, cmd_version, cmd_models, cmd_test
...
class TestModels:
    ...
    def test_list_providers(self, capsys):
        ...
        with patch.object(_global_models_api, 'providers', return_value=["openai", "anthropic"]):
    ...
    def test_list_models(self, capsys, monkeypatch):
        ...
        assert "Advanced model" in output or "model" in output  # Be less strict about exact description
