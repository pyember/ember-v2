...
def example_signature_optimization():
    ...
    trainset = [
        dspy.Example(
            text="This movie was absolutely fantastic!", sentiment="positive"
        ).with_inputs("text"),
        dspy.Example(
            text="Terrible service, would not recommend.", sentiment="negative"
        ).with_inputs("text"),
        dspy.Example(
        ...
        dspy.Example(text="Complete waste of money.", sentiment="negative").with_inputs(
            "text"
        ),
    ]
    ...
    testset = [
        ...
        dspy.Example(text="Not worth the price.", sentiment="negative").with_inputs(
            "text"
        ),
        dspy.Example(
    ...
    optimizer = BootstrapFewShotWithRandomSearch(
        metric=sentiment_metric, max_bootstrapped_demos=3, num_candidate_programs=5
    )
    ...
    for ex in testset:
        ...
        print(
            f"Predicted: {pred.sentiment}, Expected: {ex.sentiment}, Correct: {is_correct}"
        )
