...
def cmd_configure(args):
    ...
    if args.action == "get":
        ...
        if is_sensitive:
            warning = Text("⚠  Setting sensitive configuration: ", style="italic dim")
            warning.append(args.key, style="italic dim yellow")
        ...
        try:
            ...
            success.append("Successfully configured ", style="green")
            success.append(args.key, style="bold green")
            ...
            if not is_sensitive:
                console.print(f"   Value: {value}", style="dim")
