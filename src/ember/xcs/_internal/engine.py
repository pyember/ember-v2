...
class ExecutionEngine:
    ...
    def _execute_parallel(self, 
                         ...
                         info: GraphParallelismAnalysis) -> Any:
    ...
    def _execute_wave_parallel(self,
                              graph: IRGraph,
                              wave: List[str],
                              context: ExecutionContext,
    ...
    def _execute_node(self, node: IRNode, context: ExecutionContext) -> Any:
        ...
        if hasattr(node.operator, '__call__'):
            # If metadata contains the original args, use those
            # This ensures we call with the exact same arguments
