...
def build_graph_example() -> None:
    ...
    records = [
        ...
        TraceRecord(
            ...
            start_time=1.05,
            end_time=1.1,  # Executed during pipeline
        ),
        TraceRecord(
            ...
            start_time=1.1,
            end_time=1.2,  # Executed during pipeline
        ),
        TraceRecord(
            ...
            start_time=1.11,
            end_time=1.12,  # Executed during ensemble
        ),
        TraceRecord(
            ...
            start_time=1.12,
            end_time=1.13,  # Executed during ensemble
        ),
        TraceRecord(
            ...
            start_time=1.2,
            end_time=1.3,  # Executed during pipeline
        ),
        TraceRecord(
