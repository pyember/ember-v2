...
class CostTracker:
    ...
    def record_usage(self, usage: UsageStats, model_id: str) -> None:
        ...
        if usage.actual_cost_usd is not None:
            ...
            deviation_pct = (deviation / usage.actual_cost_usd * 100) if usage.actual_cost_usd > 0 else 0
            ...
            if deviation_pct > 5:
                ...
                logger.debug(
                    f"Cost reconciliation for {model_id}: "
    ...
    def get_accuracy_metrics(self) -> dict:
        ...
        if self._reconciliation_count == 0:
            return {
                ...
                "accuracy_pct": 0.0,
                "max_deviation_usd": 0.0
            }
        
        accuracy = 100.0
        if self._total_actual > 0:
            accuracy = 100.0 - abs(self._total_estimated - self._total_actual) / self._total_actual * 100
