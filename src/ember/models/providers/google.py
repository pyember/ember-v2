...
from ember._internal.pyasn1_patch import ensure_pyasn1_compatibility
from ember.models.providers.base import BaseProvider
from ember.models.schemas import ChatResponse, UsageStats

# Apply pyasn1 compatibility patch before importing google modules
...
class GoogleProvider(BaseProvider):
    ...
    def _get_api_key_from_env(self) -> Optional[str]:
        ...
        return (
            ...
            or os.getenv("EMBER_GOOGLE_API_KEY")
        )
