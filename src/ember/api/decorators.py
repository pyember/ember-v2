...
def op(fn: Callable) -> Operator:
    ...
    class FunctionOperator(Operator):
        ...
        def __call__(self, *args: Any, **kwargs: Any) -> Any:
            """Override __call__ to handle multiple arguments properly.

            This allows decorated functions to be called with their original
            signature, bypassing the single-input limitation of Operator.__call__.
            """
            # Skip validation and directly call forward with all args
