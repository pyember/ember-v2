...
def main():
    ...
    class StructuredLLMOperator(operators.Operator):
        ...
        output_model: type
        validator: ValidatedOutputOperator
...
"""
    ...
    class RobustStructuredOperator(operators.Operator):
        ...
        def forward(self, inputs):
            ...
            if result["success"]:
                return {"data": result["data"], "method": "primary", "confidence": 1.0}
            ...
            try:
                default_data = self.output_model()
                return {"data": default_data, "method": "defaults", "confidence": 0.3}
            except:
                return {"data": None, "method": "failed", "confidence": 0.0}
