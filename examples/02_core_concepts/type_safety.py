...
def example_function_protocols():
    ...
    def apply_processors(text: str, processors: List[TextProcessor]) -> List[str]:
...
def example_runtime_validation():
    ...
    def validate_input(
        data: Any, expected_type: type, field_name: str = "input"
    ) -> None:
...
def main():
    ...
    print("• EmberModel - Runtime validation")
