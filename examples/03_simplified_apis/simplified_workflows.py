...
from ember.api import models, evaluation as eval
...
def example_content_moderation_workflow():
    ...
    def check_pii(text: str) -> dict:
        ...
        prompt = (
            f"Does this contain PII (names, emails, phones)? List any found:\n{text}"
        )
        response = models("gpt-3.5-turbo", prompt).text

        has_pii = any(
            keyword in response.lower() for keyword in ["yes", "contains", "found"]
        )
    ...
    def moderate_content(text: str) -> dict:
        ...
        return {
            "text": text,
            "safe": is_safe,
            "checks": {"toxicity": toxicity, "spam": spam, "pii": pii},
        }
...
def example_data_processing_workflow():
    ...
    def analyze_question(item: dict) -> dict:
        ...
        return {**item, "difficulty": difficulty, "topic": topic}  # Keep original data
    ...
    def generate_explanation(item: dict) -> dict:
        ...
        prompt = (
            f"Explain why the answer to '{question}' is '{answer}' in 1-2 sentences."
        )
...
def example_evaluation_workflow():
    ...
    def evaluate_model_output(
        task: str, prediction: str, ground_truth: str = None
    ) -> dict:
        ...
        # Overall score
        quality_avg = sum(result["quality_scores"].values()) / len(
...
def example_rag_workflow():
    ...
    def rag_pipeline(query: str) -> dict:
        ...
        return {"query": query, "context": relevant_docs, "answer": answer.strip()}
...
def main(_simulated_mode=False):
    ...
    print_section_header("Simplified Workflows")
...
def run_simulated_examples():
    """Run workflow examples with simulated responses."""
    ...
    test_results = [
        {
            "message": "Check out this amazing offer! Click here now!!!",
            "safe": False,
            "checks": {
                "toxicity": {"toxic": False, "reason": "No harmful content detected"},
                "spam": {"spam": True, "confidence": 0.9},
                "pii": {"has_pii": False, "details": "No personal information found"},
            },
        },
        {
            "message": "Thanks for the helpful response to my question.",
            "safe": True,
            "checks": {
                "toxicity": {
                    "toxic": False,
                    "reason": "Polite and constructive message",
                },
                "spam": {"spam": False, "confidence": 0.1},
                "pii": {"has_pii": False, "details": "No personal information found"},
            },
        },
        {
            ...
            "safe": False,
            "checks": {
                "toxicity": {"toxic": False, "reason": "No harmful content"},
                "spam": {"spam": False, "confidence": 0.2},
                "pii": {
                    "has_pii": True,
                    "details": "Found email: john@example.com, phone: 555-1234",
                },
            },
        },
    ]
    ...
    processed_data = [
        {
            ...
            "difficulty": "easy",
            "topic": "math",
            "explanation": "2+2 equals 4 because adding two groups of two items gives you four items total.",
        },
        {
            ...
            "difficulty": "medium",
            "topic": "history",
            "explanation": "William Shakespeare wrote Romeo and Juliet in the early part of his career, around 1594-1596.",
        },
        {
    ...
    eval_results = [
        {
            "task": "What is the capital of France?",
            "prediction": "The capital of France is Paris.",
            "quality_scores": {"clarity": 1.0, "completeness": 0.9, "correctness": 1.0},
            "accuracy": 1.0,
            "overall_score": 0.98,
        },
        {
            "task": "Explain photosynthesis",
            "prediction": "Photosynthesis is the process by which plants convert sunlight into energy.",
            "quality_scores": {"clarity": 0.9, "completeness": 0.7, "correctness": 0.9},
            "overall_score": 0.83,
        },
    ]
    ...
    rag_results = [
        {
            ...
            "context": "The Eiffel Tower is 330 meters tall and located...",
            "answer": "The Eiffel Tower is 330 meters tall.",
        },
        {
            "query": "What is the longest river?",
            "context": "The Amazon River is approximately 6,400 kilometer...",
            "answer": "The Amazon River is the longest river at approximately 6,400 kilometers.",
        },
        {
            "query": "Which monument was a gift from France?",
            "context": "The Statue of Liberty was a gift from France to t...",
