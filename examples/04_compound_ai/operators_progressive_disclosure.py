...
def main():
    ...
    class TextProcessor(operators.Operator):
        ...
        style: str  # Automatically handled by EmberModuleMeta
        ...
        def forward(self, text: str) -> dict:
            ...
            return {"original": text, "processed": processed, "style": self.style}
    ...
    class LearnableRouter(operators.Operator):
        ...
        # Static fields (automatically handled by EmberModuleMeta)
        routes: Dict[str, str]
        embedding_dim: int
        models: Dict[str, str]

        # Dynamic fields (JAX arrays are automatically learnable)
